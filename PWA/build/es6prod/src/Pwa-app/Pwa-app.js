...
this.fire("iron-ajax-error",{request:request,error:error},{bubbles:this.bubbles,composed:!0});this.fire("error",{request:request,error:error},{bubbles:this.bubbles,composed:!0})},_discardRequest:function(request){var requestIndex=this.activeRequests.indexOf(request);if(-1<requestIndex){this.splice("activeRequests",requestIndex,1)}},_requestOptionsChanged:function(){this.debounce("generate-request",function(){if(null==this.url){return}if(this.auto){this.generateRequest()}},this.debounceDuration)}});class CardElement extends PolymerElement{constructor(){super();this.data={title:"no hay datos: intenta conectarte a una red",explanation:"",url:"../assets/estrellas.png"}}static get template(){return html`
    ...
    `}}window.customElements.define("card-element",CardElement);class PwaApp extends PolymerElement{handleResponse(event,request){console.log(request.response);this.data=request.response}static get template(){return html`
      <style>
        :host {
          display: block;
        }
